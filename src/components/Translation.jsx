        ...
        <>
            ...
            {!translating && (<div className='flex flex-col gap-1 mb-4'>
                ...
                <div className='flex items-stretch gap-2 sm:gap-4' >
                    ...
                    <button onClick={generateTranslation} className='specialBtn flex items-center gap-2 NavigationHeaderButton px-4 py-2 text-base rounded-md text-blue-400 hover:bg-blue-800 hover:text-white'>Translate</button>
                </div>
            </div>)}
        </>
    )

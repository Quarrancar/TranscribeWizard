...
export default function Information(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 max-w-prose w-full mx-auto'>
            ...
            <div className='flex items-center text-base justify-between gap-4 my-4 mx-auto w-72 max-w-full Transcription px-4 py-2 text-blue hover:text-white rounded-md hover:bg-opacity-50 '>
                <button onClick={() => setTab('transcription')} className={'px-4 rounded duration-200 py-1 hover:bg-opacity-50 ' + (tab === 'transcription' ? ' bg-blue-400 hover:bg-opacity-50 text-white' : ' text-blue-400 hover:text-blue-600')}>Transcription</button>
                <button onClick={() => setTab('translation')} className={'px-4 rounded duration-200 hover:bg-blue-400 hover:text-white py-1  ' + (tab === 'translation' ? ' bg-blue-400 hover:bg-blue-400 text-white' : ' text-blue-400 hover:text-blue-600')}>Translation</button>
            </div>

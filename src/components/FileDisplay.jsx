    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-full max-w-prose mx-auto'>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <button onClick={handleFormSubmission} className='specialBtn flex items-center gap-2 NavigationHeaderButton px-4 py-2 text-base rounded-md text-blue-400 hover:bg-blue-800 hover:text-white'>
                    <p>Transcribe</p>
